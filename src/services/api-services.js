...
class APIServies extends Helpers {
  ...
  async addPrincipalComment(body) {
  ...
  async getPrincipalComment() {
    const { data } = await axios.get(
      `${backendAPI}/principalcomment/${student_id}/${term}/${session}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${super.getToken()}`,
      },
  ...
  async MidTemResult() {
    const { data } = await axios.get(`${backendAPI}/midtermresult`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${super.getToken()}`,
      },
  ...
  async getMidTemResult() {
    const { data } = await axios.get(`${backendAPI}/midtermresult/${student_id}/${term}/${session}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${super.getToken()}`,
      },
  ...
  async getStudentByClass() {
    const { data } = await axios.get(`${backendAPI}/studentbyclass/${present_class}/${sub_class}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${super.getToken()}`,
      },
